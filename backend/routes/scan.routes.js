...
import { analyzeMedicine, getScanHistory, getScanById, deleteScan, getPublicStats, chatAboutMedicine } from '../controllers/scan.controller.js'
...
router.get('/history/:scanId', getScanById)
